...
Students are expected to have basic experience programming in python, either in a MA bootcamp or through other coursework, and have familiarity with Jupyter.  

**Assignments and Assessment**
The course will have problem sets due roughly weekly, two midterms, and a final data project.
...
One or both midterms will be done in the computer lab.
