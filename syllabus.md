...
This is a graduate course in quantitative economics, data science, and causal inference.  The course has a combination of coding and theoretical components.  All coding is done in Python.
...
In all cases the material will combine the economic theory with practical programming and datascience tools.  See the next section sor important policies on academic conduct, concessions, AI tools, and collaborating with students
...
You are responsible for ensuring that you take any exams as scheduled; no make-up exams will be given.
- Travel plans and/or cheap tickets are not a reason to miss the exams.
- If you need to miss an exam last minute (typically due to unforseen medical and other [grounds for academic concession](https://www.arts.ubc.ca/degree-planning/academic-performance/academic-concession/)) then you must submit a [self-declaration form](https://vancouver.calendar.ubc.ca/campus-wide-policies-and-regulations/academic-concession) to the instructor as soon as possible.
  -  If this is your **first self-declaration, then you can assume that it will be approved and no further documentation is required**.
  -  If you have multiple concessions in this class (including for problem sets) or across UBC, then additional documentation is required (see the [UBC Academic Concession Policy](https://vancouver.calendar.ubc.ca/campus-wide-policies-and-regulations/academic-concession)[UBC Academic Concession Policy](https://vancouver.calendar.ubc.ca/campus-wide-policies-and-regulations/academic-concession) and [UBC Arts Concession Policy](https://www.arts.ubc.ca/degree-planning/academic-performance/academic-concession/))
  - If a concession is not granted, a grade of zero will be given for the exam.

- If an Academic Concession is granted, then the instructor decides on alternative arrangements (such as moving the weight of the midterm across other portions of the class, alternative testing plan including a possible oral examination, and possibly requiring the student complete final projects solo) - depending on the exact circumstances.
